...
fid = fopen('dexter_B_AMD.txt','a');
fprintf(fid,'name = dexter, B_AMD,  epoch= %d, runTimes= %d\n', epoch, times);
fprintf(fid,'delta, lambda, eta, B, duration[s], meanLoss+std, final feaNum+std, acc+std,  testAcc+testStd \n');
for ll =1 : nn1
